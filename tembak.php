...
echo color("red","| github: VANVAN |\n");
echo color("red","| fanspage :VANgans|\n");
echo color("red","| Creator : yahahhaha         |\n");
echo "| Version : XXX X pertalite      |\n";
...
// function change(){
        ...
        $code1 = request('/goclub/v1/user-claims/enrollments', $token, '{"75% GoPay cashback for shopping & gaming"}');
        $message = fetch_value($code1,'"message":"','"');
        if(strpos($code1, 'COMPLETE')){
